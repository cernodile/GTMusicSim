...
function note (id, elem) {
	...
	switch (state) {
        case 0:img = im;return elem.id = "active";
        case 1:img = im_flat;return elem.id = "active";
        case 2:img = im_sharp;return elem.id = "active";
        case 3:img = im_drum;return elem.id = "active";
        case 4:img = im_bass;return elem.id = "active";
        case 5:img = im_flat_bass;return elem.id = "active";
        case 6:img = im_sharp_bass;return elem.id = "active";
	      case 7:img = im_spooky;return elem.id = "active";
        case 8:img = im_sax;return elem.id = "active";
        case 9:img = im_flat_sax;return elem.id = "active";
        case 10:img = im_sharp_sax;return elem.id = "active";
        case 11:img = im_repeat_begin;return elem.id = "active";
        case 12:img = im_repeat_end;return elem.id = "active";
        case 13:img = im_blank;return elem.id = "active";
    }
}
function myLoop() {
    setTimeout(function() {
    ...
    column = x;
        for (var row = 0; row < 15; row++) {
          ...
          if (arr[arrX][arrY]) {
            ...
            switch (type) {
              case "piano":c.drawImage(im_on, x + 1, y + 1, 30, 30);break;
              case "flat_piano":c.drawImage(im_flat_on, x + 1, y + 1, 30, 30);break;
              case "sharp_piano":c.drawImage(im_sharp_on, x + 1, y + 1, 30, 30);break;
              case "drum":c.drawImage(im_drum_on, x + 1, y + 1, 30, 30);break;
              case "bass":c.drawImage(im_bass_on, x + 1, y + 1, 30, 30);break;
              case "flat_bass":c.drawImage(im_flat_bass_on, x + 1, y + 1, 30, 30);break;
              case "sharp_bass":c.drawImage(im_sharp_bass_on, x + 1, y + 1, 30, 30);break;
              case "spooky":c.drawImage(im_spooky_on, x + 1, y + 1, 30, 30);break;
              case "sax":c.drawImage(im_sax_on, x + 1, y + 1, 30, 30);break;
              case "flat_sax":c.drawImage(im_flat_sax_on, x + 1, y + 1, 30, 30);break;
              case "sharp_sax":c.drawImage(im_sharp_sax_on, x + 1, y + 1, 30, 30);break;
              case "repeat_begin":c.drawImage(im_repeat_begin_on, x + 1, y + 1, 30, 30);break;
              case "repeat_end":c.drawImage(im_repeat_end_on, x + 1, y + 1, 30, 30);break;
              case "blank":c.drawImage(im_blank_on, x + 1, y + 1, 30, 30);break;
            }
          }
          if (arrX > 0) {
            if (y !== 0) {
            ...
            if (arr[arrX - 1][arrY]) {
              ...
              x = (column-1) * boxSize;
              switch (type) {
                case "piano":c.drawImage(im, x + 1, y + 1, 30, 30);break;
                case "flat_piano":c.drawImage(im_flat, x + 1, y + 1, 30, 30);break;
                case "sharp_piano":c.drawImage(im_sharp, x + 1, y + 1, 30, 30);break;
                case "drum":c.drawImage(im_drum, x + 1, y + 1, 30, 30);break;
                case "bass":c.drawImage(im_bass, x + 1, y + 1, 30, 30);break;
                case "flat_bass":c.drawImage(im_flat_bass, x + 1, y + 1, 30, 30);break;
                case "sharp_bass":c.drawImage(im_sharp_bass, x + 1, y + 1, 30, 30);break;
                case "spooky":c.drawImage(im_spooky, x + 1, y + 1, 30, 30);break;
                case "sax":c.drawImage(im_sax, x + 1, y + 1, 30, 30);break;
                case "flat_sax":c.drawImage(im_flat_sax, x + 1, y + 1, 30, 30);break;
                case "sharp_sax":c.drawImage(im_sharp_sax, x + 1, y + 1, 30, 30);break;
                case "repeat_begin":c.drawImage(im_repeat_begin, x + 1, y + 1, 30, 30);break;
                case "repeat_end":c.drawImage(im_repeat_end, x + 1, y + 1, 30, 30);break;
                case "blank":c.drawImage(im_blank, x + 1, y + 1, 30, 30);break;
              }
            }
          }
          if (y === 0 && x > 0) {
